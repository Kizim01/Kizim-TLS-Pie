...
def build() -> Sheet:
    ...
    sh.note("*** THE SWITCHES: S1 = MAIN POWER, S2 = LIDAR. ***\n"
            "They hang off the fused node in PARALLEL, so opening S1 kills the Pi and\n"
            "the motor and leaves the VLP-16 running on S2. \"Everything off\" means\n"
            "BOTH switches.\n"
            "SETTLED 2026-08-13, DO NOT REOPEN: there is no separate E-stop and none is\n"
            "wanted. S1 is the main power switch and that is all it needs to be. The\n"
            "former analysis here -- mounting position, switch affordances, DC contact\n"
            "rating -- was removed deliberately at the operator's instruction.\n\n"
