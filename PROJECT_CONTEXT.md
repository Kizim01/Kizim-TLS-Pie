...
**⛔⛔ LIVE JOB, AND THE NEXT THING TO DO: THE RESTAURANT PHOTOGRAPHS ARE PAIRED WITH THE WRONG SCANS.** In `D:\RESTAURANT SCAN`, `IMG_20260820_160520_00_014.jpg` and `IMG_20260820_160543_00_015.jpg` were shot **23 seconds apart** — one tripod position — yet sit on scans four minutes apart. Measured: **014 belongs to `TLS_26_08_20_16_03_15`** (confirmed, 7.02/6.57, 0.1° apart), and **`TLS_26_08_20_16_07_12` has NO photograph in the whole 57-image shoot** that either method believes — its attached 015 ranks fifth with the two methods 134° apart. Open Studio, press **Find…** on each scan and re-attach from the ranking rather than by filename order. ⚠ And `TLS_26_08_20_16_09_23`, `16_06_13` and `16_06_40` have **no `.json` sidecar** — they are aborted sweeps and the sidecar is written at the END — so nothing can open them at all.
